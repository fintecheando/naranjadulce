...
public class TransactionService implements TransactionServiceInterface {
    ...
    public void requestRemoveTransaction(String transactionId) throws APIException {
        ...
        transactionRepository.remove(transaction.getTransactionId());
    }
    ...
    public Transaction requestNewTransaction(Transaction transaction) throws APIException {
        ...
        if(transaction.getSending()) {
            ...
            saved = transactionRepository.find(transaction.getTransactionId());
            ...
            if(otherAccount != null) {
                ...
                Transaction otherSaved = null;
                transactionRepository.add(recipientTransaction);
                otherSaved = transactionRepository.find(recipientTransaction.getTransactionId());
