...
public class OAuth2RepositoryTokenStore implements TokenStore {
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        ...
        this.oAuth2AccessTokenRepository.add(accessToken);
    }
    ...
    public void removeAccessToken(OAuth2AccessToken token) {
        ...
        if (accessToken != null) {
            this.oAuth2AccessTokenRepository.remove(accessToken.getTokenId());
        }
    }
    ...
    public void storeRefreshToken(OAuth2RefreshToken refreshToken, OAuth2Authentication authentication) {
        this.oAuth2RefreshTokenRepository.add(new OAuth2AuthenticationRefreshToken(refreshToken, authentication));
    }
    ...
    public void removeRefreshToken(OAuth2RefreshToken refreshToken) {
        ...
        this.oAuth2RefreshTokenRepository.remove(authRefreshToken.getTokenId());
    }
    ...
    public void removeAccessTokenUsingRefreshToken(OAuth2RefreshToken refreshToken) {
        ...
        this.oAuth2AccessTokenRepository.remove(accessToken.getRefreshToken());
    }
